      ...
      >
        ...
        <div className="px-3 pb-3 flex-shrink-0 space-y-1" style={{ borderTop: '1px solid rgba(255,255,255,0.05)', paddingTop: '12px' }}>
          ...
          <Link
            ...
            style={{ color: location.pathname === '/settings' ? 'rgba(255,255,255,0.85)' : 'rgba(255,255,255,0.4)', background: location.pathname === '/settings' ? 'rgba(79,110,247,0.14)' : 'transparent', textDecoration: 'none' }}
            onMouseEnter={e => { if (location.pathname !== '/settings') { e.currentTarget.style.background = 'rgba(255,255,255,0.07)'; e.currentTarget.style.color = 'rgba(255,255,255,0.75)' } }}
            onMouseLeave={e => { if (location.pathname !== '/settings') { e.currentTarget.style.background = 'transparent'; e.currentTarget.style.color = 'rgba(255,255,255,0.4)' } }}
          >
            <span style={{ color: location.pathname === '/settings' ? '#818cf8' : 'rgba(255,255,255,0.3)' }}>
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8}
